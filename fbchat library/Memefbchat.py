...
username = "np03a180160@heraldcollege.edu.np"
password = "Loveumom"
...
class EchoBot(Client):   
    ...
    def onMessage(self, author_id, message_object, thread_id, thread_type, **kwargs):
        ...
        msg = memefy(message_object.text)
        # If you're not the author, echo
        if author_id != self.uid:
            self.send(memefy(message_object), thread_id=thread_id, thread_type=thread_type)

try:
    client = EchoBot(username, password, session_cookies=session_cookies)
except:
